...
const FAQ = () => {
  ...
  const faqDescription = 'Честные ответы на вопросы об экспертных консультациях по продажам в HoReCa. Гарантии, сроки, стоимость, реальные результаты. MARICO PRO.';
...
Плюс вы платите за 13 лет опыта в премиальном HoReCa. Мой путь к эксперту — от линейных позиций до куратора закрытого клуба в Москве, аналогов которому нет.
